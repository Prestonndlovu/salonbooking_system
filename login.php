<?php
    ...
    if (isset($_POST['emailcont']) && isset($_POST['password'])) {
        $emailcon=$_POST['emailcont'];
        $password=$_POST['password'];

        // Check if the username and password match the database record
        $query = "SELECT * FROM clients WHERE email='$emailcon' AND password='$password'";
    ...
    /*if(isset($_POST['login']))
    {
        ...
        $query=mysqli_query($conn,"select client_id from clients where  (email='$emailcon' || contact_no='$emailcon') && password='$password' ");
...
<html lang="en">
  <head>
    <title>Love Yourself | Login</title>
